...
export const en = {
  ...
  "footer.newsletter.label": "Your email",
  ...
  /* Errors.
     ...
     Keyed by the server's customer-message key, plus the two codes the boot
     failure in api/index.js can return. The client resolves error.<key>
     through this dictionary, so an error is translated like every other
     string instead of arriving in English on a French page. */
  "error.auth.invalid": "That email address or password is not right.",
  "error.network": "We could not reach Brandora. Check your connection and try again.",
  "error.CONFIGURATION_INCOMPLETE": "The service is not fully configured yet. Nothing you entered has been lost — our team has been notified.",
  "error.SERVICE_UNAVAILABLE": "The service is temporarily unavailable. Nothing you entered has been lost — try again in a moment.",
  "error.unknown": "Something went wrong. Please try again.",

  "state.loading": "Loading…",
  "state.catalog.loading": "Loading the catalogue…",
  "state.catalog.empty": "No product matches your search.",
  "state.catalog.unavailable": "We cannot load the catalogue at the moment.",
  "state.catalog.preparing": "Our catalogue is being prepared. Come back soon, or tell us what you are looking for.",
  "state.interview.loading": "Preparing your interview…",
  "state.interview.error": "We could not load your interview.",
  "state.account.creating": "Creating your account…",
  "state.signing-in": "Signing you in…",
  "state.session.expired": "Your session has expired. Please sign in again.",
  ...
  "account.noscript": "Enable JavaScript to manage your account.",
  "account.signed-out": "Sign in to manage your account.",
  "account.title": "Account settings",
  "account.lede":
    "View your account information, and change your password or email address whenever you need to — no one else has to do this for you.",
  ...
  "error.auth.email-taken": "That email address is already in use by another account.",
  ...
  "error.storage.not-configured": "Image storage isn't set up yet. The product was saved without this photo.",
  "error.storage.upload-failed": "Unable to upload image. Please check the file type and size, then try again.",
  "error.storage.delete-failed": "Unable to remove that image right now. Please try again.",
  ...
  "sourcing.alt.cupsSet":
    "An iced drink cup, dome lid and straw shown together",
  "sourcing.alt.cupChart":
    "A supplier's sizing chart for clear portion cups, 30 to 300ml",
  "sourcing.alt.bagsColour":
    "Die-cut handle bags in five colours",
  "sourcing.alt.cupDomeNavy":
    "A clear cup with a domed lid",
  "sourcing.alt.boxKraftSmall":
    "A small kraft box, shown closed and open",
  "sourcing.alt.boxKraftStacked":
    "Two kraft boxes stacked",
  "sourcing.alt.boxShippingPink":
    "A pink shipping box open on its shredded-paper filler",
  "sourcing.alt.trayBagasse":
    "A compartmented fibre food tray with its lid",
  "sourcing.alt.boxKraftWindow":
    "A kraft box with a clear window, closed and open",
  "sourcing.alt.bagsKraftHandles":
    "Kraft bags with rope handles, several sizes",
  ...
  "legal.privacy.intro":
    "Brandora Union (\u201cBrandora\u201d, \u201cwe\u201d) builds brands and sources the physical products behind them for small businesses, from Abidjan, C\u00f4te d'Ivoire. This page describes what we collect through brandoraunion.online, why, and what you can ask us to do about it.",
  "legal.privacy.h.collect": "What we collect",
  "legal.privacy.p.collect-1":
    "When you create an account: your name, email address and password, and \u2014 only if you choose to give them \u2014 your country and phone number.",
  "legal.privacy.p.collect-2":
    "When you use the brand builder: your answers to the interview questions (your business, product, audience and positioning), and the brand, identity and package that Brandora generates from them.",
  "legal.privacy.p.collect-3":
    "When you request a quote, place an order, or upload a logo for a manufacturer: the details you enter in that form, and the file itself.",
  "legal.privacy.p.collect-4":
    "If you sign in with Google, we receive the name, email address and profile photo Google shares for that purpose \u2014 nothing else from your Google account.",
  "legal.privacy.h.use": "Why we use it",
  "legal.privacy.p.use":
    "To run your account, generate your brand, price and fulfil your orders, answer your quote requests, and reply when you contact us. We do not sell your data, and we do not use it to show you advertising.",
  "legal.privacy.h.share": "Who we share it with",
  "legal.privacy.p.share-1":
    "A small number of providers process data on our behalf, only for the purpose stated: Anthropic generates your brand strategy and identity from your interview answers; Resend delivers our transactional emails (account, orders, quotes); Paystack processes payments \u2014 Brandora never sees or stores your card details; and, if you use them, Google for sign-in and Calendly for booking a call operate under their own privacy policies for that interaction.",
  "legal.privacy.p.share-2":
    "We do not share your data with anyone else, and we do not run advertising or analytics trackers on this site.",
  "legal.privacy.h.cookies": "Cookies and local storage",
  "legal.privacy.p.cookies":
    "One cookie keeps you signed in \u2014 it identifies your session and nothing else, and it is not readable by any script on this page. Your language, your light-or-dark preference, and which brand you were last working on are kept in your browser's own storage, on your device, so returning to the site does not lose them.",
  "legal.privacy.h.retention": "How long we keep it",
  "legal.privacy.p.retention-1":
    "We keep your data for as long as your account is active. We do not yet have a self-service way to export or delete your account \u2014 email",
  "legal.privacy.p.retention-2":
    "and we will handle it directly.",
  "legal.privacy.h.rights": "Your rights",
  "legal.privacy.p.rights":
    "You can ask us what we hold about you, ask us to correct it, or ask us to delete it, at the same address. We will act on a deletion request unless we are required to keep something \u2014 a paid order's record, for example \u2014 for accounting or legal reasons.",
  "legal.privacy.h.children": "Children",
  "legal.privacy.p.children":
    "Brandora is a business-to-business service and is not directed at children. We do not knowingly collect data from anyone under 16.",
  "legal.privacy.h.changes": "Changes to this policy",
  "legal.privacy.p.changes":
    "If this policy changes in a way that matters, we will update the date at the top of this page and, for a significant change, tell you by email.",
  "legal.privacy.h.contact": "Contact",

  "legal.terms.title": "Terms of service",
  "legal.terms.updated": "Last updated August 2026.",
  "legal.terms.intro":
    "These are the terms for using brandoraunion.online, run by Brandora Union from Abidjan, C\u00f4te d'Ivoire. Creating an account, requesting a quote, or placing an order means you accept them.",
  "legal.terms.h.service": "The service",
  "legal.terms.p.service-1":
    "Brandora generates a brand \u2014 a name, positioning, palette and identity \u2014 from the answers you give, and helps you turn it into physical products from our catalogue. Some products carry a fixed price at a given quantity; others are marked \u201cprice on request\u201d because the cost depends on a freight quote we have not yet obtained, and we will not show you an invented figure in its place.",
  "legal.terms.p.service-2":
    "There is no manufacturer marketplace on Brandora yet. Clicking a product photo to request a quote sends your request to us by email; we follow up directly rather than through an automated portal.",
  "legal.terms.h.accounts": "Accounts",
  "legal.terms.p.accounts":
    "You are responsible for the accuracy of the information on your account and for keeping your password confidential. You must be able to enter into a binding contract to create one.",
  "legal.terms.h.orders": "Orders, pricing and payment",
  "legal.terms.p.orders-1":
    "Prices are shown in West African CFA francs (XOF) and include Brandora's sourcing and coordination margin. A quote is valid for the period stated on it; after that, prices may have changed and a new quote is needed.",
  "legal.terms.p.orders-2":
    "Payment is processed by Paystack. We never see or store your card details. An order is confirmed once payment is verified as received.",
  "legal.terms.h.delivery": "Delivery",
  "legal.terms.p.delivery":
    "Delivery charges shown at checkout are Brandora's own local delivery fee, not a carrier's quote \u2014 we do not publish a delivery date until one has actually been confirmed for your order.",
  "legal.terms.h.cancellation": "Cancellations",
  "legal.terms.p.cancellation":
    "Because most orders are manufactured for you rather than held in stock, cancellation terms depend on how far production has gone when you ask \u2014 contact us as soon as you know, and we will tell you exactly where things stand.",
  "legal.terms.h.ip": "Intellectual property",
  "legal.terms.p.ip":
    "The brand, name and identity Brandora generates for you are yours once your order is paid. Brandora Union retains ownership of the software, the catalogue and the site itself.",
  "legal.terms.h.liability": "Liability",
  "legal.terms.p.liability":
    "We work to get pricing, availability and delivery information right, but Brandora is not liable for indirect losses arising from delays or errors outside our reasonable control, including from our suppliers or payment provider.",
  "legal.terms.h.law": "Governing law",
  "legal.terms.p.law":
    "These terms are governed by the law of C\u00f4te d'Ivoire.",
  "legal.terms.h.changes": "Changes to these terms",
  "legal.terms.p.changes":
    "If we change these terms in a way that matters, we will update the date at the top of this page.",
  "legal.terms.h.contact": "Contact",

  "ui.catalog.see-details": "See details for {product}",
  "ui.catalog.see-details-short": "See details",

  "product.back": "← Back to the catalogue",
  "product.not-found": "This product could not be found. It may have been removed from the catalogue.",
  "product.quote.title": "Request a quote",
  "product.quote.lede": "No account needed. Describe what you need and we'll reply by email.",
  "product.quote.not-instant": "This is a customization request, not an instant purchase: Brandora Union confirms the shipping cost and exact timeframe after reviewing your request.",
  "product.quote.name": "Your name",
  "product.quote.company": "Company / brand (optional)",
  "product.quote.email": "Email",
  "product.quote.phone": "Phone (optional)",
  "product.quote.quantity": "Quantity needed",
  "product.quote.material": "Material",
  "product.quote.shape": "Shape",
  "product.quote.dimensions": "Dimensions",
  "product.quote.quality": "Quality / specification",
  "product.quote.quality-placeholder": "e.g. food-grade, matte finish",
  "product.quote.color": "Colour / preference",
  "product.quote.color-placeholder": "e.g. navy blue, natural kraft",
  "product.quote.timeframe": "Expected shipping / delivery timeframe (optional)",
  "product.quote.timeframe-placeholder": "e.g. within 4 weeks",
  "product.quote.deliveryMethod": "Delivery or pickup",
  "product.quote.deliveryMethod.unset": "Not decided yet",
  "product.quote.deliveryMethod.delivery": "Delivery",
  "product.quote.deliveryMethod.pickup": "Pickup",
  "product.quote.customization": "Customization wanted",
  "product.quote.custom.logo": "Logo",
  "product.quote.custom.design": "Full design",
  "product.quote.custom.printing": "Printing",
  "product.quote.custom.sticker": "Sticker",
  "product.quote.custom.embossing": "Embossing",
  "product.quote.custom.other": "Other",
  "product.quote.logo": "Upload your logo / design (optional)",
  "product.quote.destination": "Destination",
  "product.quote.destination-placeholder": "City, country",
  "product.quote.message": "Additional message (optional)",
  "product.quote.submit": "Request a quote",
  "product.quote.sent-title": "Request sent",
  "product.quote.sent-body": "We've received your request. We'll reply by email.",
  "product.quote.bad-quantity": "Enter a whole number greater than zero.",
  "product.detail.height": "height",
  "product.detail.no-photo": "No photo yet.",
  "product.detail.material": "Material",
  "product.detail.shape": "Shape",
  ...
  "pricing.title": "How pricing works",
  "pricing.lede": "A formula, not an eyeballed guess. Here is exactly what makes up the price you see, and why.",
  "pricing.formula.label": "The formula",
  "pricing.formula.text": "Final price = Product cost + Shipping cost + Brandora service margin",
  "pricing.h.product-cost": "Product cost",
  "pricing.p.product-cost": "What the manufacturer charges for the product itself, from the real supplier behind every item in the catalogue — never an approximate figure.",
  "pricing.h.shipping-cost": "Shipping cost",
  "pricing.p.shipping-cost": "The estimated — or, once confirmed, real — logistics cost tied to your order: international freight, customs and local delivery, as applicable.",
  "pricing.h.margin": "Brandora service margin",
  "pricing.p.margin-1": "A transparent percentage, added on top of the product cost and shipping cost together, to cover sourcing, supplier coordination, quality control, order management and running the platform. This rate is configurable rather than hardcoded — it is currently set to",
  "pricing.p.margin-2": ", within a disclosed range of 25 to 35%.",
  "pricing.h.example": "A worked example",
  "pricing.example.product": "Product cost",
  "pricing.example.shipping": "Shipping cost",
  "pricing.example.margin": "Brandora margin",
  "pricing.example.total": "Final price",
  "pricing.example.note": "For illustration only — your real quotes are shown in West African CFA francs (XOF).",
  "pricing.h.states": "Estimated, then confirmed",
  "pricing.states.estimated-label": "Estimated price",
  "pricing.p.states-1": "— calculated from the product chosen, the quantity, and an estimated supplier cost and shipping. This is what you see while browsing the catalogue.",
  "pricing.states.confirmed-label": "Confirmed quote",
  "pricing.p.states-2": "— once we have spoken with the manufacturer: final supplier price, confirmed shipping, and the same Brandora margin. Manufacturing prices move with minimum quantity, material, customization, packaging, destination and shipping method — the confirmed quote accounts for all of it.",
  "pricing.h.transparency": "What we show, what we keep private",
  "pricing.p.transparency": "We are transparent about the method: your price is product cost + shipping + Brandora's service margin. The exact cost negotiated with each supplier stays in our internal system — being transparent about the formula does not mean disclosing our suppliers' confidential commercial terms.",
} as const;
