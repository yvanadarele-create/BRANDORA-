...
export const es: Catalogue = {
  ...
  "account.noscript": "Activa JavaScript para gestionar tu cuenta.",
  "account.signed-out": "Inicia sesión para gestionar tu cuenta.",
  "account.title": "Configuración de la cuenta",
  "account.lede":
    "Consulta la información de tu cuenta y cambia tu contraseña o tu correo electrónico cuando lo necesites — sin depender de nadie más.",
  "account.field.name": "Nombre",
  "account.field.email": "Correo electrónico",
  "account.field.role": "Rol",
  ...
  "account.password.success":
    "Contraseña cambiada. Sigues conectado en este dispositivo — se cerraron todas las demás sesiones.",
  "account.password.mismatch": "La nueva contraseña y su confirmación no coinciden.",
  "account.email.title": "Cambiar correo electrónico",
  "account.email.current": "Contraseña actual",
  "account.email.new": "Nueva dirección de correo electrónico",
  "account.email.submit": "Cambiar correo electrónico",
  "account.email.success": "Dirección de correo electrónico actualizada.",
  ...
  "error.auth.email-taken": "Esa dirección de correo ya está en uso por otra cuenta.",
