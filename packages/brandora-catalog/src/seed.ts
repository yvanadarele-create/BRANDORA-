...
const SOURCING_SEED: SeedInput[] = [
  ...
  /* --- Homepage gallery photos with no product behind them yet -----------
   *
   * These seven were on the homepage's "What we can have made" gallery from
   * 17 Aug 2026 (commit 9df002f, studio photography from the Yison Printing
   * catalogue — folding cartons, counter displays, rigid gift boxes,
   * mailers, printed boxes, drawer boxes) but were deliberately kept out of
   * the catalogue at the time: "not a catalogue, and no prices... examples
   * of what those factories produce." That distinction is invisible on the
   * page itself — a photo that looks the same as every other tile but does
   * not click through to anything reads as broken, not as deliberate — so
   * they get the same sourcingInProgress treatment as everything else here.
   */
  {
    id: "prd_box_folding_carton_printed",
    name: "Printed folding carton, several colourways",
    nameFr: "Étui pliant imprimé, plusieurs coloris",
    category: "packaging",
    subcategory: "boxes",
    description:
      "Studio photograph from a manufacturer's own catalogue, not yet a confirmed Brandora order — no supplier or price confirmed for a specific size or print run.",
    descriptionFr:
      "Photographie de studio issue du catalogue d'un fabricant, pas encore une commande confirmée par Brandora — aucun fournisseur ni prix confirmé pour une taille ou un tirage particulier.",
    material: "Coated paperboard, printed",
    colors: ["assorted"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this carton — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/boxes-folding-cartons.webp"],
  },
  {
    id: "prd_box_counter_display",
    name: "Printed counter display box, with matching small boxes",
    nameFr: "Présentoir de comptoir imprimé, avec petites boîtes assorties",
    category: "packaging",
    subcategory: "boxes",
    description:
      "Studio photograph from a manufacturer's own catalogue, not yet a confirmed Brandora order — no supplier or price confirmed for a specific size or print run.",
    ...
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this display box — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/boxes-display.webp"],
  },
  {
    id: "prd_box_rigid_gift",
    name: "Rigid gift box with printed sleeve and inserts",
    nameFr: "Boîte cadeau rigide avec manchon imprimé et calages",
    category: "packaging",
    subcategory: "boxes",
    description:
      "Studio photograph from a manufacturer's own catalogue, not yet a confirmed Brandora order — no supplier or price confirmed for a specific size or print run.",
    descriptionFr:
      "Photographie de studio issue du catalogue d'un fabricant, pas encore une commande confirmée par Brandora — aucun fournisseur ni prix confirmé pour une taille ou un tirage particulier.",
    material: "Rigid board, printed sleeve",
    colors: ["assorted"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this box — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/boxes-rigid-gift.webp"],
  },
  {
    id: "prd_box_mailer_printed_colour",
    name: "Printed mailer box",
    nameFr: "Boîte d'expédition imprimée",
    category: "packaging",
    subcategory: "boxes",
    description:
      "Studio photograph from a manufacturer's own catalogue, not yet a confirmed Brandora order — no supplier or price confirmed for a specific size or print run.",
    descriptionFr:
      "Photographie de studio issue du catalogue d'un fabricant, pas encore une commande confirmée par Brandora — aucun fournisseur ni prix confirmé pour une taille ou un tirage particulier.",
    material: "Corrugated board, printed",
    colors: ["green"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this box — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/boxes-mailer.webp"],
  },
  {
    id: "prd_box_small_printed_candle",
    name: "Small printed box, sized for a candle",
    nameFr: "Petite boîte imprimée, dimensionnée pour une bougie",
    category: "packaging",
    subcategory: "boxes",
    description:
      "Studio photograph from a manufacturer's own catalogue, not yet a confirmed Brandora order — no supplier or price confirmed for a specific size or print run.",
    ...
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this box — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/boxes-small-printed.webp"],
  },
  {
    id: "prd_box_printed_pink_yellow",
    name: "Printed box, pink and yellow",
    nameFr: "Boîte imprimée, rose et jaune",
    category: "packaging",
    subcategory: "boxes",
    description:
      "Studio photograph from a manufacturer's own catalogue, not yet a confirmed Brandora order — no supplier or price confirmed for a specific size or print run.",
    ...
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this box — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/boxes-printed-colour.webp"],
  },
  {
    id: "prd_box_drawer_three_colour",
    name: "Drawer box, three colourways",
    nameFr: "Boîte tiroir, trois coloris",
    category: "packaging",
    subcategory: "boxes",
    description:
      "Studio photograph from a manufacturer's own catalogue, not yet a confirmed Brandora order — no supplier or price confirmed for a specific size or print run.",
    ...
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this box — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/boxes-drawer.webp"],
  },

  /* --- Sixth photo batch, 27 Aug 2026 — the pouch line and novelty bags -- */
  {
    id: "prd_pouch_kraft_plain",
    name: "Plain kraft stand-up pouch, several sizes",
    nameFr: "Sachet kraft debout uni, plusieurs tailles",
    category: "packaging",
    subcategory: "pouches",
    description:
      "Kraft stand-up pouch with a resealable zip, no window, shown across a range of sizes. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet kraft debout à fermeture zip, sans fenêtre, présenté dans une gamme de tailles. Aucun fabricant confirmé pour l'instant.",
    ...
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this pouch — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/pouch-kraft-plain-multisize.webp"],
  },
  {
    id: "prd_pouch_kraft_window_multisize",
    name: "Kraft stand-up pouch with window, several sizes",
    nameFr: "Sachet kraft debout avec fenêtre, plusieurs tailles",
    category: "packaging",
    subcategory: "pouches",
    description:
      "Kraft stand-up pouch with a resealable zip and a clear window, shown filled and empty across a range of sizes. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet kraft debout à fermeture zip et fenêtre transparente, montré rempli et vide dans une gamme de tailles. Aucun fabricant confirmé pour l'instant.",
    material: "Kraft paper laminate, clear window",
    colors: ["kraft"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    ...
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this pouch — tell us your size and quantity and Brandora will source it."),
    images: [
      "/assets/img/sourcing/pouch-kraft-window-multisize.webp",
      "/assets/img/sourcing/pouch-kraft-window-multisize-2.webp",
    ],
  },
  {
    id: "prd_pouch_metallic_silver",
    name: "Silver metallic stand-up pouch, several sizes",
    nameFr: "Sachet métallisé argent debout, plusieurs tailles",
    category: "packaging",
    subcategory: "pouches",
    description:
      "Metallic silver stand-up pouch with a resealable zip, shown across a range of sizes. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet métallisé argent debout à fermeture zip, présenté dans une gamme de tailles. Aucun fabricant confirmé pour l'instant.",
    material: "Metallised film laminate",
    colors: ["silver"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this pouch — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/pouch-metallic-silver-multisize.webp"],
  },
  {
    id: "prd_pouch_clear_spout_handle",
    name: "Clear stand-up spout pouch with carry handle",
    nameFr: "Sachet debout transparent à bec verseur et poignée",
    category: "packaging",
    subcategory: "pouches",
    description:
      "Clear stand-up pouch with a screw-cap spout and a die-cut carry handle, shown filled with dry-goods samples. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet debout transparent avec bec verseur à vis et poignée découpée, montré rempli d'échantillons de produits secs. Aucun fabricant confirmé pour l'instant.",
    material: "Clear plastic laminate",
    colors: ["clear"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this pouch — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/pouch-clear-spout-handle.webp"],
  },
  {
    id: "prd_pouch_clear_zip_standup",
    name: "Clear stand-up zip pouch",
    nameFr: "Sachet debout transparent à zip",
    category: "packaging",
    subcategory: "pouches",
    description:
      "Clear stand-up pouch with a resealable zip, shown filled with dried fruit and nuts. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet debout transparent à fermeture zip, montré rempli de fruits secs et de noix. Aucun fabricant confirmé pour l'instant.",
    material: "Clear plastic laminate",
    colors: ["clear"],
    minimumQuantity: 0,
    availableQuantity: 0,
    ...
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this pouch — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/pouch-clear-zip-standup.webp"],
  },
  {
    id: "prd_pouch_matte_colour_assorted",
    name: "Matte colour stand-up pouch, assorted colourways",
    nameFr: "Sachet debout mat coloré, coloris variés",
    category: "packaging",
    subcategory: "pouches",
    description:
      "Matte finish stand-up pouch with a tear-notch zip, shown in ten colourways. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet debout finition mate à zip avec encoche de déchirure, présenté en dix coloris. Aucun fabricant confirmé pour l'instant.",
    material: "Matte film laminate",
    colors: ["blue", "yellow", "pink", "grey", "orange", "red", "green", "black"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this pouch — tell us your size and quantity and Brandora will source it."),
    images: [
      "/assets/img/sourcing/pouch-matte-colour-assorted.webp",
      "/assets/img/sourcing/pouch-matte-colour-assorted-2.webp",
    ],
  },
  {
    id: "prd_bag_novelty_handbag",
    name: "Novelty handbag-shaped treat pouch",
    nameFr: "Sachet friandise en forme de sac à main",
    category: "packaging",
    subcategory: "bags",
    description:
      "Die-cut handbag-shaped treat pouch, two colourways, two sizes each. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet friandise découpé en forme de sac à main, deux coloris, deux tailles chacun. Aucun fabricant confirmé pour l'instant.",
    ...
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown([], "No manufacturer confirmed yet for this bag — tell us your quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/bag-novelty-handbag-shape.webp"],
  },
  {
    id: "prd_bag_flat_poly_pastry",
    name: "Flat poly bag, sized for a single pastry",
    nameFr: "Sachet plat, dimensionné pour une pâtisserie individuelle",
    category: "packaging",
    subcategory: "bags",
    description:
      "Flat, open-top poly bag sized for one pastry, shown with a doughnut and a slice of bread. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet plat, ouvert, dimensionné pour une pâtisserie individuelle, montré avec un beignet et une tranche de pain. Aucun fabricant confirmé pour l'instant.",
    material: "Clear plastic / kraft-backed film",
    colors: ["clear", "kraft"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown([], "No manufacturer confirmed yet for this bag — tell us your quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/bag-flat-poly-pastry.webp"],
  },
  {
    id: "prd_bag_novelty_animal",
    name: "Animal-shaped novelty treat bag",
    nameFr: "Sachet friandise en forme d'animal",
    category: "packaging",
    subcategory: "bags",
    description:
      "Die-cut treat bags shaped like a dog, a deer, an elephant and a dinosaur. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachets friandise découpés en forme de chien, cerf, éléphant et dinosaure. Aucun fabricant confirmé pour l'instant.",
    material: "Plastic laminate",
    colors: ["assorted"],
    minimumQuantity: 0,
    availableQuantity: 0,
    ...
    sourcingInProgress: true,
    customization: unknown([], "No manufacturer confirmed yet for this bag — tell us your quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/bag-novelty-animal-shapes.webp"],
  },
  {
    id: "prd_bag_novelty_bus",
    name: "Bus-shaped novelty treat bag",
    nameFr: "Sachet friandise en forme de bus",
    category: "packaging",
    subcategory: "bags",
    description: "Die-cut school-bus-shaped treat bags, four colourways. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachets friandise découpés en forme de bus scolaire, quatre coloris. Aucun fabricant confirmé pour l'instant.",
    material: "Plastic laminate",
    ...
    sourcingInProgress: true,
    customization: unknown([], "No manufacturer confirmed yet for this bag — tell us your quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/bag-novelty-bus-shape.webp"],
  },
  {
    id: "prd_bag_novelty_hologram_skull",
    name: "Holographic skull-shaped novelty treat bag",
    nameFr: "Sachet friandise holographique en forme de crâne",
    category: "packaging",
    subcategory: "bags",
    description: "Die-cut holographic treat bag shaped like a skull, resealable zip. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet friandise holographique découpé en forme de crâne, fermeture zip. Aucun fabricant confirmé pour l'instant.",
    material: "Holographic plastic film",
    colors: ["holographic"],
    minimumQuantity: 0,
    availableQuantity: 0,
    quoteOnRequest: true,
    sourcingInProgress: true,
    customization: unknown([], "No manufacturer confirmed yet for this bag — tell us your quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/bag-novelty-hologram-skull.webp"],
  },
  {
    id: "prd_bag_novelty_christmas_cellophane",
    name: "Christmas cellophane treat bag",
    nameFr: "Sachet friandise cellophane de Noël",
    category: "packaging",
    subcategory: "bags",
    description:
      "Cellophane treat bags printed with winter cartoon characters, closed with a gold twist tie. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachets friandise en cellophane imprimés de personnages de dessin animé hivernaux, fermés par un lien doré torsadé. Aucun fabricant confirmé pour l'instant.",
    material: "Cellophane (OPP)",
    ...
    sourcingInProgress: true,
    customization: unknown([], "No manufacturer confirmed yet for this bag — tell us your quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/bag-novelty-christmas-cellophane.webp"],
  },
  {
    id: "prd_bag_novelty_christmas_shapes",
    name: "Christmas gift-shaped novelty treat bag",
    nameFr: "Sachet friandise de Noël en forme de cadeau",
    category: "packaging",
    subcategory: "bags",
    description: "Die-cut treat bags in Christmas shapes and characters. No manufacturer confirmed yet.",
    descriptionFr: "Sachets friandise découpés en formes et personnages de Noël. Aucun fabricant confirmé pour l'instant.",
    material: "Plastic laminate",
    colors: ["assorted"],
    minimumQuantity: 0,
    availableQuantity: 0,
    ...
    sourcingInProgress: true,
    customization: unknown([], "No manufacturer confirmed yet for this bag — tell us your quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/bag-novelty-christmas-gift-shapes.webp"],
  },
  {
    id: "prd_pouch_coffee_matte_illustrated",
    name: "Matte coffee bag, illustrated",
    nameFr: "Sachet à café mat illustré",
    category: "packaging",
    subcategory: "pouches",
    description:
      "Matte finish coffee bag, grey and white, printed with a farmhouse illustration, shown in four sizes. No manufacturer confirmed yet.",
    descriptionFr:
      "Sachet à café finition mate, gris et blanc, imprimé d'une illustration de ferme, présenté en quatre tailles. Aucun fabricant confirmé pour l'instant.",
    material: "Matte film laminate",
    colors: ["grey", "white"],
    minimumQuantity: 0,
    availableQuantity: 0,
    ...
    sourcingInProgress: true,
    customization: unknown(["logo-print"], "No manufacturer confirmed yet for this bag — tell us your size and quantity and Brandora will source it."),
    images: ["/assets/img/sourcing/pouch-coffee-matte-illustrated.webp"],
  },
];
