 ...
 *
 * Prefixed rather than a bare `DATABASE_PATH` so Brandora cannot end up sharing
 * a file with anything else deployed beside it: one schema's migration would
 * corrupt the other's tables, and the failure would look like data loss rather
